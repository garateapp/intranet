export default function QuickLinkCard({ link }) {
    return (
        <a
            ...
            className="group portal-card-accent block rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-1"
        >
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="text-base font-semibold text-gray-900 truncate group-hover:text-green-700">
                        {link.title}
                    </h3>
                    {link.description && (
