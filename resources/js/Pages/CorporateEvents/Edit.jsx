...
export default function Edit({ event }) {
    ...
    function submit(e) {
        e.preventDefault();
        put(route('corporate-events.update', event.id));
    }

    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Evento: {event.title}</h2>}
        >
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="type" value={data.type} onChange={(e) => setData('type', e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" />
                                    </div>
                                    <div>
