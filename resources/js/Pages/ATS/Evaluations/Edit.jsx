...
export default function Edit({ evaluation }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('ats.evaluations.update', evaluation.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800">Editar Evaluación</h2>
                </div>
            }
        >
            <Head title="Editar Evaluación - ATS" />
            ...
            <div className="mx-auto max-w-2xl">
                <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="flex justify-end gap-3">
                        <Link
                            href={route('ats.interviews.show', evaluation.interview_id)}
