...
export default function Edit({ interview }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('ats.interviews.update', interview.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800">Editar Entrevista</h2>
                </div>
            }
        >
            <Head title="Editar Entrevista - ATS" />
            ...
            <div className="mx-auto max-w-2xl">
                <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="flex justify-end gap-3">
                        <Link
                            href={route('ats.applications.kanban', interview.application?.vacancy?.id)}
